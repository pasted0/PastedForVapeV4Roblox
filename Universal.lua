...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/pasted0/PastedForVapeV4/refs/heads/main"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
		assert(suc, res)
