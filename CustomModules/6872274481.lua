...
run(function()
	...
	size_changer = GuiLibrary.ObjectsThatCanBeSaved.RenderWindow.Api.CreateOptionsButton({
...
run(function()
	...
	Anime = GuiLibrary.ObjectsThatCanBeSaved.BlatantWindow.Api.CreateOptionsButton({
		Name = 'AnimeImages',
		Function = function(calling)
			if calling then 
				pcall(function()
...
local Antihit = GuiLibrary.ObjectsThatCanBeSaved.BlatantWindow.Api({
    ...
    HoverText = "Simple AntiHit Made By Me Pasted0",
    Default = false,
    ExtraText = function() return " Method Part" end 
})
